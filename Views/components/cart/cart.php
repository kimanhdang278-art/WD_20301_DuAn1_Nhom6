                              ...
                              <tr>
                                  <th scope="row">
                                      <div class="d-flex align-items-center">
                                          <img src="uploads/<?= $item['image'] ?>" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                      </div>
                                  </th>
                                  <td>
                                  ...
                                  <td>
                                      <div class="input-group quantity mt-4" style="width: 100px;">
                                          ...
                                          <input type="text" class="form-control form-control-sm text-center border-0" min="1" value="<?= $item['quantity'] ?>">
                                          <div class="input-group-btn">
                                  ...
                                  <td>
                                      <p class="mb-0 mt-4"><?= number_format($subTotal) ?>vnd</p>
                                  </td>
                                  <td>
                                      <a href="?view=cart&action=delete&id=<?=$item['id'] ?>" class="btn btn-md rounded-circle bg-light border mt-4">
              ...
              <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                  <div class="bg-light rounded">
                      ...
                      <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                          ...
                          <p class="mb-0 pe-4"><?= number_format($total + 10000) ?></p>
                      </div>
