     ...
     <div class="container py-5">
         <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
             <div class="row g-4">
                 <div class="col-lg-3">
                     <a href="#">
                         <h1 class="text-primary mb-0">Trái cây</h1>
         ...
         <div class="row g-5">
             ...
             <div class="col-lg-3 col-md-6">
                 <div class="d-flex flex-column text-start footer-item">
                     ...
                     <a class="btn-link" href="">Sản phẩm chi tiết</a>
             ...
             <div class="col-lg-3 col-md-6">
                 <div class="footer-item">
                     ...
                     <p>Địa chỉ:Phạm Hùng, Cái Răng, Cần Thơ</p>
                     <p>Email: orannic@gmail.com</p>
         ...
         <div class="row">
             <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                 <span class="text-light">
                     <a href="#"><i class="fas fa-copyright text-light me-2"></i>@Organic</a>,
