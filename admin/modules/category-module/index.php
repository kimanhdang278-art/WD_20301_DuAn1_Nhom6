<a href="?role=admin&module=category&action=create" type="button" class="btn btn-primary mb-3">
    Thêm Mới
    ...
    <div class="card-footer">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                ?>
                <li class="page-item"><a class="page-link" href="?role=admin&module=category&page=1">Trước</a></li>
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <li class="page-item"><a class="page-link" href="?role=admin&module=category&page=<?= $i ?>"><?= $i ?></a></li>
                <?php endfor; ?>
                <li class="page-item"><a class="page-link" href="role=admin&module=category&page=<?= $totalPages ?>">Sau</a></li>
            </ul>
        </nav>
    </div>
</div>