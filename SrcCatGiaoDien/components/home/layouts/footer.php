            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <a href="#">
                        ...
                        <p class="text-secondary mb-0">Sản phẩm tươi ngon</p>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Chúng tôi cam kết mang đến sản phẩm tươi ngon nhất với chất lượng vượt trội. Được khách hàng tin tưởng và lựa chọn từ những ngày đầu thành lập.</p>
